...
Sau khi platform gửi event WebSocket vào middleware (port 8020, path `/ws/platform/lazada`), luồng tự động chạy:
...
| WS | `/ws/platform/{platform}` | WebSocket nhận event từ platform |
